...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO --data --scenario pp --conditions auto:run2_data --era Run2_2018 --process RERECO --eventcontent RECO --datatier RECO --filein dummy.root --secondfilein dummy.root --python_filename=test/run_MyTest_PhaseIPixelNtuplizer_Data_2018_106X_cfg.py --runUnscheduled -n -1 --no_exec
